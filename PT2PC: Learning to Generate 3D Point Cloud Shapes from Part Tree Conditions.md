...
- Part-tree conditioned **generator**
	...
	- Part point cloud decoder. The point cloud decoder is designed to deform a fixed surface point cloud of a unit cube into target part point cloud based on its input. Specifically, the input is a 1000-size point cloud and each point's coordinate is concatenated with the part feature. A
...
## References
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MjUxMzE4NzcsMjU4NTE4MTg1LDE5MD
EzNjkwOTQsMTM3OTU1NDA1NV19
-->